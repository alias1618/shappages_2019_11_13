...
$sql_insert = "INSERT INTO customer_form_answer(customer_form_answer, user_id, customer_form_id, role_id) VALUES ('$customer_service_answer', '$user_id', '$customer_form_id', '$role_id')";
