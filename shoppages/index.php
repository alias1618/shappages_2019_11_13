    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="#" class="list-group-item">罐頭食品</a>
          ...
          <ol class="carousel-indicators">
            ...
            <li data-target="#carouselExampleIndicators" data-slide-to="1" ></li>
             <li data-target="#carouselExampleIndicators" data-slide-to="2"></li>
          		...
          		<?php 
          		$counter=0;
		$sql_query03 = "SELECT * FROM product WHERE product_status_id != 3 ORDER BY RAND() LIMIT 10 ";
...
<!--
        ...
        <div class="row">
			<?php
			$sql ="SELECT * FROM product WHERE product_status_id != 3 ";
			...
			$sql_query01 = "SELECT * FROM product WHERE product_status_id != 3"; //!=
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                ...
                <h4 class="card-title">
                  ...
                  <a href="#"><?php echo '<a href="shop_detail.php?product_id=',$product_id,  '">', $product_name, '</a>';?></a>
                </h4>
                <h5><?php echo $product_price;?>元</h5>
