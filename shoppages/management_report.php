...
<?php 
		...
		<table border="1">
			...
			$sql_query_02="select DISTINCT month(buy_date) from report";
			...
			while($row_02 = mysqli_fetch_array($result_02)){
			    $month_02 = $row_02['month(buy_date)'];
			
			$date_from_01 = '2019-';
			$date_from_02 = '-01 00:00:00';
			$date_to_01 = '2019-';
			$date_to_02 = '-31 23:59:59';
			$set = "";
			//ORDER BY product_id
			$sql_query_01 =
			"SELECT product_id, sum(buy_number), product_name, product_price, product_buy_price, sum(buy_money)
            FROM report
            WHERE buy_date BETWEEN '$date_from_01.$month_02.$date_from_02' AND '$date_to_01.$month_02.$date_to_02'
...
*/
            ...
            <tr>
               ...
               <!-- <td><a href="order_delete.php?buy_id=<?php //echo $buy_id;?>">取消訂單</a></td>-->
                 <td><a href="report_list_month.php?month_02=<?php echo $month_02;?>">月份明細</a></td>               
